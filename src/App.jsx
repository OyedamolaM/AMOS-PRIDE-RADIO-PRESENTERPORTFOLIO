...
const mediaItems = [
  {
    ...
    caption:
      "A smooth on-air segment showcasing controlled delivery, timing, and vocal clarity.",
  },
  {
    title: "Cruise Control",
    type: "audio",
    src: "/audio/rot-2.mp3",
    caption: "A tighter radio presentation focused on clean projection and disciplined on-air presence.",
  },
  {
    title: "Cruise Control 2",
    type: "audio",
    src: "/audio/rto-1.mp3",
    caption: "A lively broadcast segment built around warmth, flow, and strong listener connection.",
  },
  {
    title: "Friday Cruise",
    type: "audio",
    src: "/audio/friday-cruise.mp3",
    caption: "A drive-time radio segment defined by steady pacing, presence, and live audience engagement.",
  },
  {
    title: "Radio Takeover",
    type: "audio",
    src: "/audio/afternoon-cruise.mp3",
    caption: "A composed live broadcast reinforcing tone, confidence, and style",
  },
  {
    title: "Radio Takeover 2",
    type: "audio",
    src: "/audio/rto-3.mp3",
